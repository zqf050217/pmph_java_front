...
;(function ($, window, document) {
    ...
    SelectList.prototype = {
        ...
        getSelectedIndex: function (element) {
            var $this = $(element),
                selectedIndex = $this.get(0).selectedIndex || this.settings.placeholder ? -1 : 0;
        ...
        renderSelect: function (element) {
            ...
            if (that.settings.fiter) {
                ...
                selectHTML += '<input placeholder' + that.settings.placeholder + ' type="button" class="select-button" value="' + selectedOptionText + '" />';
            }
            selectHTML += '<div class="select-list"><ul>';
        ...
        setSelectStyle: function (element) {
            ...
            $(selectID).children('.select-button').css({
                ...
                height: that.setStyleProperty(that.settings.height) + 'px',
                'line-height': that.setStyleProperty(that.settings.height) + 'px',
        ...
        setSelectEvent: function (element) {
            var that = this,
                ...
                selectedIndex = that.getSelectedIndex($this),
                selectLength = that.getOptionCount($this),
                selectBtn = $(selectID + ' input[type="text"]'),
            ...
            if (that.settings.enable) {
                ...
                if (that.settings.fiter) {
                    $(selectID).children(".select-button").bind('input propertychange', function () {
                        ...
                        $.each($(selectID + ' li'), (function (i) {
                            if ($(this).text().indexOf($that.val()) >= 0) {
                                $(this).css("display", "list-item");
                            } else {
                ...
                $(selectID)
                    ...
                    .on('focusin', 'input[type="text"]', function () {
